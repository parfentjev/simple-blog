...
public class PostDto {
   ...
   */
  public PostDto(String id, String title, String summary, String text, OffsetDateTime date, Boolean visible) {
    this.id = id;
    this.title = title;
  ...
  public PostDto summary(String summary) {
    this.summary = summary;
    return this;
  }
  ...
  public PostDto visible(Boolean visible) {
    this.visible = visible;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, postDto.id) &&
        ...
        Objects.equals(this.summary, postDto.summary) &&
        Objects.equals(this.text, postDto.text) &&
        Objects.equals(this.date, postDto.date) &&
        Objects.equals(this.visible, postDto.visible);
  }
