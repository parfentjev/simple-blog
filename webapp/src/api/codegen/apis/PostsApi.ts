...
export class PostsApi extends runtime.BaseAPI {
     ...
     */
    async postsEditorGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<PostPreviewDto>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(PostPreviewDtoFromJSON));
    }

    /**
     * Get all posts, both published and drafts
     */
    async postsEditorGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<PostPreviewDto>> {
        const response = await this.postsEditorGetRaw(initOverrides);
     ...
     * Get published posts
     */
    async postsPublishedGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<PostPreviewDto>>> {
        const queryParameters: any = {};
     ...
     * Get published posts
     */
    async postsPublishedGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<PostPreviewDto>> {
        const response = await this.postsPublishedGetRaw(initOverrides);
        return await response.value();
    }
