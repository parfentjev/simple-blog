...
public class FeedService {
  ...
  public void updateMastodonFeed() {
    ...
    // step 3: render (in a controller)

    /*
      <blockquote class="mastodon-embed"
          data-embed-url="https://mastodon.ie/@placebo/116080972147027609/embed"
          ...
          <a href="https://mastodon.ie/@placebo/116080972147027609" target="_blank"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  width="32" height="32" viewBox="0 0 79 75">
                  <path
              ...
              <div style="color: #787588; margin-top: 16px;">Post by @placebo@mastodon.ie</div>
              <div style="font-weight: 500;">View on Mastodon</div>
          </a>
      </blockquote>
      <script data-allowed-prefixes="https://mastodon.ie/" async src="https://mastodon.ie/embed.js"></script>
    */
  }
}
