...
const MediaListPage: FC = () => {
  ...
  if (!page || page.items.length === 0) return <p className="text-center">There are no media files yet!</p>
  ...
  return (
    <div>
      ...
      <Paginator page={page.page} totalPages={page.totalPages} urlPath="/admin/media/" />
    </div>
  )
}
